        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="p-2 bg-gradient-to-tr from-emerald-500 to-indigo-600 rounded-lg">
              ...
              >
                <path d="M18 20a3.5 3.5 0 0 0 3-4c0-3.5-3.5-8-5-10h-2c-1.5 0-2 1-2 2v9a2 2 0 0 0 2 2h4Z" />
                <path d="M6 20a3.5 3.5 0 0 1-3-4c0-3.5 3.5-8 5-10h2c1.5 0 2 1 2 2v9a2 2 0 0 1-2 2H6Z" />
              </svg>
            </div>
